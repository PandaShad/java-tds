...
public class Exercice1Local {

    ArrayList<ModuleNonStatic> array;
    
    public void treatments() {

        class Treatments1 implements Consumer<ModuleNonStatic> {
        ...
        class Treatments2 implements Consumer<ModuleNonStatic> {
        ...
        class Treatments3 implements Consumer<ModuleNonStatic> {
        ...
        array.forEach(new Treatments1());
        System.out.println("=====================================================");
        System.out.println("Treatment 2");
        array.forEach(new Treatments2());
        System.out.println("=====================================================");
        System.out.println("Treatment 3");
        array.forEach(new Treatments3());
        System.out.println("=====================================================");
    }

    public Exercice1Local(ArrayList<ModuleNonStatic> array) {
        this.array = array;
    }

    public static void main(String[] argv) throws Exception {
        Exercice1Local e = new Exercice1Local(new ArrayList<ModuleNonStatic>());
