...
public class Exercice1Static {

    ArrayList<ModuleNonStatic> array;

    public Exercice1Static(ArrayList<ModuleNonStatic> array) {
        this.array = array;
    }

    public static class Treatments1 implements Consumer<ModuleNonStatic> {
    ...
    public static class Treatments2 implements Consumer<ModuleNonStatic> {
    ...
    public static class Treatments3 implements Consumer<ModuleNonStatic> {
    ...
    public static void main(String[] argv) throws Exception {
        Exercice1Static e = new Exercice1Static(new ArrayList<ModuleNonStatic>());
        ...
        e.array.forEach(new Exercice1Static.Treatments1());
        System.out.println("=====================================================");
        System.out.println("Treatment 2");
        e.array.forEach(new Exercice1Static.Treatments2());
        System.out.println("=====================================================");
        System.out.println("Treatment 3");
        e.array.forEach(new Exercice1Static.Treatments3());
        System.out.println("=====================================================");
    }
}
