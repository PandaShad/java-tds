...
public class App {
  ...
  public static void analyseClasse(String nomClasse) throws ClassNotFoundException {
    ...
    afficheClassAnnotation(annotations);
  ...
  public static void afficheClassAnnotation(Annotation[] annotations) {
    for(int i = 0; i<annotations.length; i++) {
        System.out.println(annotations[i]);
        // Class currenAnnotationType = annotations[i].annotationType();
        // System.out.println("@" + currenAnnotationType.getSimpleName());
    }
